...
camera.position.z = 300;
    randomPoints.push(
        ...
        new THREE.Vector3(mercury.planet.position.x + 1.5*mercury.size, 5, 300),
        new THREE.Vector3(mercury.planet.position.x + 1.5*mercury.size, 5, 0),
        new THREE.Vector3((venus.planet.position.x + mercury.planet.position.x)/2, 10, -50),
        new THREE.Vector3(venus.planet.position.x + 2*venus.size, 10, 0),  //reched venus
        new THREE.Vector3((earth.planet.position.x + venus.planet.position.x)/2, 15, 170),
        new THREE.Vector3(earth.planet.position.x + 2*earth.size, 15, 0),
        new THREE.Vector3(mars.planet.position.x + 2*mars.size, 20, -40),
        new THREE.Vector3(mars.planet.position.x + 2*mars.size, 20, 0),
        new THREE.Vector3(2000, 200, 500),
        new THREE.Vector3(2000, 0, 500),
